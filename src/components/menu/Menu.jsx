      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {menuData.map((item, index) => (
            ...
            <div
              key={index}
              className="menu-item  bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-yellow-200 shadow-black  hover:bg-gray-900  transform transition duration-500 opacity-0 "
